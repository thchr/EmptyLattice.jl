...
# - nothing (3D): two orthonormal vectors perpendicular to q (Phase 2, not yet implemented)
...
- `nothing` (3D): not yet implemented (Phase 2).
"""
function polarization_vectors(
    ...
    elseif isnothing(polarization)
        error("3D polarization basis not yet implemented (Phase 2)")
    else
